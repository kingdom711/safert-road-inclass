...
public class AiAnalysisRequest {
    ...
    @Schema(description = "체크리스트 ID", example = "1", requiredMode = Schema.RequiredMode.REQUIRED)
    private Long checklistId;
    
    @NotBlank(message = "분석할 내용은 필수입니다.")
    @Size(max = 5000, message = "분석 내용은 5000자 이하여야 합니다.")
    @Schema(description = "분석할 체크리스트 내용 텍스트", example = "안전모 착용 여부: 미착용, 안전난간 상태: 불안정, 작업 높이: 2층", requiredMode = Schema.RequiredMode.REQUIRED)
