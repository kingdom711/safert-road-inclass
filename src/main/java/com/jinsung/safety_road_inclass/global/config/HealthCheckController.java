...
public class HealthCheckController {
    ...
    @Operation(summary = "상세 헬스체크", description = "서버의 상세 상태 정보를 반환합니다. 상태, 타임스탬프, 애플리케이션 이름, 버전, 환경 정보를 포함합니다.")
    @GetMapping
    ...
    @Operation(summary = "간단한 헬스체크", description = "로드밸런서나 모니터링 시스템에서 사용하는 간단한 헬스체크 엔드포인트입니다.")
    @GetMapping("/ping")
